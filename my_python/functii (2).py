...
# def suma2(par1, par2, **kwargs):
#     print(par1)
#     print(par2)
#     print(kwargs)

# suma2(par1=10, par2=20, par3=30, par4=40)
...
# [INFO] Start program Utilizator: Anisoara
# [INFO] Start program | Utilizator: Anisoara
# [ERROR] Eroare la conectare

# action = "Start program"
# user = 'Anisoara'
# logare(f'Action: {action}', f'User: {user}', 15554, "Attempts: 1", nivel="DEBUG", separator=' | ', ionut=45)
# print()
# logare('Eroare la conectare', nivel='ERROR')

# def suma2(**kwargs):
#     '''
#     calculea suma numerelor introduse ca si keyward arguments

#     :param kwargs: numere de tip int
#     '''
...
# print(suma2(par1=10, par2=20, par3=30, par4=40))
