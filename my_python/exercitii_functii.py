...
#16. Bonus .... Scrieti o functie de la tastatura care 
# primeste o lista si returneaza suma tuturor numerelor.
#Ex: 1 | 3 | 4 | 6 | 9 | 75
...
# lista = [int(i.strip()) for i in char.split("|")]

# rezultat = suma_numerelor(lista)

# print("Rezultat final: ", lista)
# print("Rezultatul este: ", rezultat)

#17. Bonus.... Scrie o functie care primeste un dictionar de forma {nume: varsta} si returneaza un dictionar
#  cu persoanele care au varsta peste 18 ani.
...
# print(filtru(persoane))  # cod colega 

# ************************************************

# persoane = {} # Creezi un dicționar gol. Aici se vor salva persoanele:

# def filtru(persoane): #Definești o funcție numită filtru. Ea primește un dicționar numit persoane.
#     rezultat = {} #Creezi un dicționar gol unde vei pune doar persoanele care au peste 18 ani.

#     for nume, varsta in persoane.items():#Parcurgi dicționarul.
#         if varsta >= 18: #Verifici dacă persoana este majoră.
#             rezultat[nume] = varsta #Dacă are cel puțin 18 ani, o adaugi în dicționarul rezultat.

#     return rezultat #Funcția returnează dicționarul final cu persoanele majore.

# while True: #Pornești o buclă infinită. Programul cere date până când scrii stop.
#     date = input("Introduceti date: ") #Citești de la tastatură un text de forma:

#     if date == "stop":
#         break  #Dacă utilizatorul scrie stop, se oprește bucla.

#     date_separate = date.split() #Împarți textul după spații.

#     nume = date_separate[2] #Iei elementul de pe index 2, adică numele:
#     varsta = int(date_separate[-1]) #Iei ultimul element, adică vârsta:

#     persoane[nume] = varsta #Adaugi în dicționar:

# print(filtru(persoane)) #După ce scrii stop, se apelează funcția 
#                         #filtru(persoane) și se afișează doar persoanele majore.
